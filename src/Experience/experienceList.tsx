...
const experienceList: Experience[] = [
    {
        ...
        stack:
            'HTML5, CSS3, LESS, JavaScript/ES6+, React, NodeJs, Express, MongoDB, AWS',
        details: ['foo', 'bar'],
    },
    {
        company: 'HSBC',
        ...
        stack:
            'Javascript/ES6, Angular4, Typescript, Rx, ReactJS, Vue2, Chart.js, Jasmine, Karma, Protractor',
        details: [
    ...
    },
    {
        ...
        stack:
            'Javascript, AngularJS, Underscore, jQuery, HTML5, CSS3, SASS, Groovy, Jasmine, Karma, SinonJs, GruntJs, Bower, Groovy, Jenkins',
        details: [
    ...
    },
    {
        ...
        stack:
            'Javascript, AngularJS, jQuery, HTML5, CSS3, LESS, Jasmine, Karma, GruntJs, TeamCity',
        details: [
    ...
    },
    {
        ...
        stack:
            'Javascript, jQuery, WebScript, HTML, CSS, Liferay Portal, Alfresco ECM',
        details: [
    ...
    },
    {
        ...
        stack:
            'Javascript, jQuery, HTML, CSS, Liferay Portal, Joomla Portal, Alfresco ECM',
        details: [
    ...
    },
    {
        ...
        stack: 'Javascript, HTML, CSS, ActionScript',
        details: [
            'As a web developer, I create websites for different small business and public associations.',
        ],
    },
];
